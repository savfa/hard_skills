...
## Self-Check
1. Что произойдет, если в Event Loop микрозадача будет создавать новую микрозадачу бесконечно?
2. Как можно использовать замыкания для создания приватных переменных?
3. В чем ключевое различие между `interface` и `type` в TypeScript?
4. Что делает ключевое слово `infer` в условных типах?
